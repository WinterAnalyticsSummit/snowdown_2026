...
•	Custoemr IDs that begin with “C” are non-members.
...
Important:
All discounts are already reflected in net_price (i.e., the stored value represents the final amount paid after the discount is applied).
________________________________________
4. Data Tables
________________________________________
4.1 Table: members
